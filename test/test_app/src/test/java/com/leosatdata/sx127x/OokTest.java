...
public class OokTest {
	...
	public void testRegisters() {
		OpMode req = new OpMode(sx127x_mode_t.SLEEP, sx127x_modulation_t.OOK);
		rx.sx127x_set_opmod(req);
		...
		assertEquals(sx127x_ook_thresh_type_t.PEAK, rx.sx127x_ook_get_ook_thresh_type());
		...
		assertEquals(sx127x_ook_thresh_type_t.FIXED, rx.sx127x_ook_get_ook_thresh_type());
		...
		assertEquals(sx127x_ook_thresh_type_t.AVG, rx.sx127x_ook_get_ook_thresh_type());
	}

	@Test
	public void testReset() {
		rx.sx127x_set_opmod(new OpMode(sx127x_mode_t.SLEEP, sx127x_modulation_t.OOK));
		rx.sx127x_set_frequency(frequency);
